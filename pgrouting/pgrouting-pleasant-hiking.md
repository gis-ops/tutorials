...
![OpenStreetMap not Routable](https://github.com/gis-ops/tutorials/raw/master/pgrouting/static/img/osm2po-topology.jpg "OpenStreetMap data in its pure form is not routable")
...
![Google Maps from Coogee to Bondi](https://github.com/gis-ops/tutorials/raw/master/pgrouting/static/img/google-coogee-bondi.jpg "Google Maps from Coogee to Bondi")
...
![pgRouting from Coogee to Bondi using the ST_Length](https://github.com/gis-ops/tutorials/raw/master/pgrouting/static/img/google-coogee-bondi.jpg "pgRouting from Coogee to Bondi using the ST_Length")
...
![pgRouting from Coogee to Bondi Guiding Dijkstra along the Coast](https://github.com/gis-ops/tutorials/raw/master/pgrouting/static/img/pgr_adapted_least_cost_path.jpg "pgRouting from Coogee to Bondi Guiding the Algorithm along the Coast")
